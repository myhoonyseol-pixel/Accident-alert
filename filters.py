...
# 작업 동사의 '하-' 활용형.
#
# WORK_WORDS 에는 '공사 중'·'공사중' 같은 명사형만 있었습니다. 그런데 기사
# 제목은 동사형을 훨씬 자주 씁니다. 그래서 실제 사망사고를 놓쳤습니다.
#   2026-09-03 "아파트 6층 베란다 창틀 공사하던 2명 추락해 숨져" (2명 사망)
#   → '건설현장'도 '공사 중'도 없어서 장소 판정에서 통째로 탈락
#
# '공사하던'·'공사하다'·'공사하는'을 하나씩 넣으면 끝이 없으므로 어미로 잡습니다.
# ⚠️ '수리'는 넣지 마세요. "농기계 수리하던 70대 사망" 같은 게 걸립니다.
_WORK_VERB = ("공사|시공|신축|증축|개축|철거|해체|굴착|터파기|타설|양중|인양|"
              "용접|도장|도색|미장|방수|조적|단열|배관|설치|보수")
_WORK_VERB_RE = re.compile(rf"(?:{_WORK_VERB})\s*(?:하[던는다여고였었]|했)")
